...
namespace Manager.Server.Services
{
    public class BlogCommentService : IBlogCommentService
    {
        ...
        public async Task<int> CountAsync(Expression<Func<BlogComment, bool>> expression, bool isTrack = true)
        {
            return await baseService.Entities<BlogComment>().Where(expression).CountAsync();
        }

        public async Task<PagedList<BlogComment>?> PagedAsync(int pageIndex = 1, int pageSize = 10, int offset = 0, bool isTrack = true, string orderBy = "", Guid? id = null, Guid? bId = null, Guid? uId = null, CommentType[]? types = null, Guid? pId = null, Guid? grp = null, DateTime? startTime = null, DateTime? endTime = null, Status? status = null)
        {
        ...
        public async Task<PagedList<BlogComment>> PagedAsync(Expression<Func<BlogComment, bool>> whereLambda, int pageIndex = 1, int pageSize = 10, int offset = 0, bool isTrack = true, string orderBy = "")
        {
            return await baseService.QueryPagedAsync(whereLambda, pageIndex, pageSize, offset, isTrack, orderBy);
        }

        public async Task<bool> AddAsync(BlogComment blogComment)
        {
