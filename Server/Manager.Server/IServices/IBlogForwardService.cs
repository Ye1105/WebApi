...
namespace Manager.Server.IServices
{
    public interface IBlogForwardService
    {
        ...
        /// <returns></returns>
        Task<int> CountAsync(Expression<Func<BlogForward, bool>> expression, bool isTrack = true);
        ...
        /// <returns></returns>
        Task<bool> AddAsync(Blog blog, BlogForward blogForward);
        ...
        /// <param name="blogForward"></param>
        /// <returns></returns>
        Task<Tuple<bool, string>> DeleteAsync(Guid id, Guid uId);
    }
}